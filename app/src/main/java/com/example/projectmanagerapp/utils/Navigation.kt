...
import com.example.projectmanagerapp.ui.main.CardDetailScreen
...
fun AppNavHost(navController: NavHostController, modifier: Modifier) {
    NavHost(navController = navController, startDestination = AppDestinations.CARD_DETAIL_ROUTE, modifier = modifier) {
